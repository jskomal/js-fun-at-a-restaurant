...
var stockCount = 3
// note that the following functions are not tied to the instructions, I'm only using them for testing
function checkStock() {
    if (stockCount >= 1) {
...
var vegetables = ['lettuce', 'broccoli', 'asparagus', 'celery', 'spinach'];

// Write the code to access the 3rd element of the Array, using bracket
// notation.

//note that the console.log is not necessary, I'm just using it to run the file for testing
console.log(vegetables[2]);

// Create a new variable "fruits" and assign it to an Array of 7
// different fruits.
var fruits = ['apple', 'bananna', 'mango', 'orange', 'kiwi', 'lemon', 'lime'];
...
// Other keys that would make sense would include hours of operation, has a Starbucks inside,
// hasPharmacy, numOfRows, hasSelfCheckout, etc.
